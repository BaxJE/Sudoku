 ...
 */
public static class Sudoku extends JFrame {
   ...
   public final Color OPEN_CELL_BGCOLOR = Color.YELLOW;
   public final Color OPEN_CELL_TEXT_YES = new Color(0, 255, 0);  // RGB
   public final Color OPEN_CELL_TEXT_NO = Color.RED;
   public final Color CLOSED_CELL_BGCOLOR = new Color(240, 240, 240); // RGB
   public final Color CLOSED_CELL_TEXT = Color.BLACK;
   public final Font FONT_NUMBERS = new Font("Monospaced", Font.BOLD, 20);
